...
# Establecer un nivel de registro más alto para httpx para evitar que se registren todas las solicitudes GET y POST
...
async def main() -> NoReturn:
    ...
    TOKEN = "6778482085:AAFIFrVRwRAvEQzl-w1xx7z-gvIyAtVnGp4"
    assert TOKEN is not None, "Falta el TOKEN en la variable de entorno"
